...
export default function Home() {
  ...
  return (
    <div >
     <Head>
     <title>Koirinewz - Free Hawakhyali News</title>
    ...
    <div className="container-fluid p-0">
        <nav className="navbar navbar-expand-lg bg-dark navbar-dark py-2 py-lg-0 px-lg-5">
            ...
            <div className=" navbar-collapse justify-content-between px-0 px-lg-3" id="navbarCollapse">
    ...
    >
      ...
      <SwiperSlide>   <div className="  overflow-hidden " style={{height: "300px"}}>
